% Preface+Chapter-1_draft-subworld_book1.tex
% Laast modified: 
%
%
%
...
\usepackage[top=3cm,bottom=3cm,nohead,nofoot]{geometry} % Added manually
\pagestyle{plain} % Added manually
\pagenumbering{gobble} % eats all page numbers % Added manually
\usepackage{multicol} % Added manually
\usepackage{lmodern}
...
\begin{multicols}{2} % Added manually
